...
import com.atschoolPioneerSchool.model.Student;
 ...
 public class ActivityMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.setOnNavigationItemSelectedListener(navelistener);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.messag_ic:
                Intent n = new Intent(this, ActivityMain.class);
                ...
                break;
            case R.id.news_ic:
                Intent n1 = new Intent(this, ActivityMain.class);
                Bundle m1Bundle = new Bundle();
                m1Bundle.putString("SelectedMenu", String.valueOf(R.id.nav_News));
                n1.putExtras(m1Bundle);
                startActivity(n1);
                break;
            case R.id.alerts_ic:
                Intent n2 = new Intent(this, ActivityNotification.class);
                Student friend = new Student("Notifications", 1, 2625);
                n2.putExtra(ActivityChatDetails.KEY_FRIEND, friend);
                startActivity(n2);
                break;
        }
         ...
         public boolean onNavigationItemSelected(@NonNull MenuItem item) {
             ...
             switch (item.getItemId()){
                 ...
                 case R.id.location_btn:
                     // ActivityKidBus.navigate((ActivityMain.this) ,findViewById(R.id.lyt_parent), new Student());
                     Intent iv = new Intent(ActivityMain.this, ActivityMain.class);
                     Bundle mvBundle = new Bundle();
                     mvBundle.putString("SelectedMenu", String.valueOf(R.id.nav_Busses));
                     iv.putExtras(mvBundle);
